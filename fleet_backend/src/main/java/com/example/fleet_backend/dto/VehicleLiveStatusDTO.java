...
public class VehicleLiveStatusDTO {
    ...
    public VehicleLiveStatusDTO(Long vehicleId, String vehicleName, Double latitude, Double longitude,
                                Double speed, boolean engineOn, LocalDateTime timestamp, String liveStatus,
                                boolean missionActive, Long missionId, String currentDriverName,
                                String routeId, String routeSource, List<MissionRoutePointDTO> missionRoute) {
