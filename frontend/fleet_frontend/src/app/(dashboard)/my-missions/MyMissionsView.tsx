    ...
    <div className="space-y-6 p-6 md:p-10">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <button
          ...
          onClick={onRefresh}
          disabled={refreshing}
          className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm transition-all hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
        >
      ...
      {driverRestInfo ? (
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 shadow-sm">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-amber-300 bg-white px-3 py-1 text-xs font-extrabold text-amber-700">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-5 py-3 text-sm font-extrabold text-white hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
              ...
              >
                ...
                <div className="grid gap-3 text-sm text-slate-700">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      {m.departure || "Unknown"} → {m.destination || "Unknown"}
                    </span>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    >
                      ...
                      {busy && m.status === "PLANNED" ? "Starting..." : "Start"}
                    </button>
                    ...
                    >
                      <Flag className="h-4 w-4" />
                      {busy && m.status === "IN_PROGRESS" ? "Finishing..." : "Finish"}
                    </button>
                  </div>
