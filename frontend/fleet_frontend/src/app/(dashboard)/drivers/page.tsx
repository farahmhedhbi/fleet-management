...
export default function DriversPage() {
  ...
  // ✅ selon ta logique finale : owner peut supprimer SES drivers
  ...
  async function loadDrivers() {
    try {
      ...
      // ✅ sécurité front : toujours tableau
  ...
  return (
    <ProtectedRoute requiredRoles={["ROLE_OWNER", "ROLE_ADMIN"]} requireOwnerActive>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
              <div className="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-2xl">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <InfoRow label="Numéro de permis" value={selectedDriver.licenseNumber} />
                  <InfoRow
                    label="Expiration permis"
                    value={selectedDriver.licenseExpiry?.split("T")[0] || "—"}
                  />
                  <InfoRow label="Statut" value={selectedDriver.status || "ACTIVE"} />
                  <InfoRow
                    label="Eco score"
                    value={
