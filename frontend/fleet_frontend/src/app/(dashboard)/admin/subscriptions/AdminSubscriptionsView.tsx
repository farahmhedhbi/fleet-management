                        ...
                        >
                          ...
                          {(p.note ||
                            ...
                            <div className="mt-4 grid gap-3">
                              ...
                              {(p.proofFileUrl || p.adminProofFileUrl) && (
                                <div className="grid gap-3 md:grid-cols-2">
                                  <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm text-slate-700">
                                    ...
                                    {p.proofFileUrl ? (
                                      <button
                                        type="button"
                                        onClick={() => openFile(p.proofFileUrl)}
                                        className="inline-flex items-center gap-2 rounded-lg bg-slate-900 px-3 py-2 text-xs font-extrabold text-white"
                                      >
                                        <FileText className="h-4 w-4" />
                                        {p.proofFileName ||
                                          "Ouvrir fichier owner"}
                                      </button>
                                    ) : (
                                  ...
                                  <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm text-slate-700">
                                    ...
                                    {p.adminProofFileUrl ? (
                                      <button
                                        type="button"
                                        onClick={() =>
                                          openFile(p.adminProofFileUrl)
                                        }
                                        className="inline-flex items-center gap-2 rounded-lg bg-emerald-600 px-3 py-2 text-xs font-extrabold text-white"
                                      >
                                        <FileText className="h-4 w-4" />
                                        {p.adminProofFileName ||
                                          "Ouvrir fichier admin"}
                                      </button>
                                    ) : (
                                      <div className="text-slate-500">
                                        Aucun fichier admin.
