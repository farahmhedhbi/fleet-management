...
/* Petit helper : combine des classes Tailwind proprement */
function cn(...classes: (string | false | undefined)[]) {
  return classes.filter(Boolean).join(" ");
}

/* Badge simple pour afficher des avantages (icône + texte) */
...
/* Wrapper pour un champ : label + input + (optionnel) petit hint */
function InputShell({
  label,
  required,
  children,
...
export default function RegisterView({
  ...
  /* Rôle sélectionné (pour affichage à gauche) */
      ...
      <div className="relative mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 py-10 sm:px-6 lg:grid-cols-2 lg:gap-12 lg:px-8 lg:py-16">
        ...
        <div className="order-2 lg:order-1">
          ...
          <p className="mt-4 max-w-xl text-lg leading-relaxed text-slate-600">
            Accédez au suivi, aux missions, aux alertes et au pilotage KPI.
          </p>
          ...
          <div className="relative mx-auto w-full max-w-xl">
            ...
            <div className="rounded-[32px] border border-slate-200 bg-white/85 p-7 shadow-xl backdrop-blur sm:p-8">
              ...
              <form onSubmit={onSubmit} className="mt-7 space-y-5">
                ...
                {/* License Number : affiché seulement si DRIVER */}
